#ifndef REGIONS_NUCLEO_F429ZI_H
#define REGIONS_NUCLEO_F429ZI_H
...
// <i> Device Family Pack (DFP):   Keil::STM32F4xx_DFP@3.0.0-dev2
// <i> Board Support Pack (BSP):   Keil::NUCLEO-F429ZI_BSP@1.0.0-dev
