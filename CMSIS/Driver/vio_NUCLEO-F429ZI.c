/******************************************************************************
 * @file     vio_NUCLEO-F429ZI.c
 * @brief    Virtual I/O implementation for board NUCLEO-F429ZI
 * @version  V1.0.0
...
/*! \page vio_NUCLEO-F429ZI Physical I/O Mapping
...
//  signal,     pin,                   pull resistor,      active state
  { vioLED0,    GPIO_PIN_ID_PORTB(14), ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH },
  { vioLED1,    GPIO_PIN_ID_PORTB(0),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH },
